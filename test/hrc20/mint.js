...
const userAddress = "0xea877e7412c313cd177959600e655f8ba8c28b40";
...
module.exports = function() {
    async function getHarmonyERC20Information() {
        ...
        let mybalance = await instance.balanceOf(userAddress);
        
        console.log('Starting Transfer')
        const tx = await instance.transfer(userAddress, transferAmount);
        console.log(tx)
